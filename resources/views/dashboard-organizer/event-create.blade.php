    ...
    <div class="flex h-screen">
        ...
        <aside class="w-72 glass-panel border-r border-white/10 flex flex-col fixed h-full overflow-y-auto">
            ...
            <nav class="flex-1 p-4 space-y-1">
                ...
                <a href="{{ route('organizer.event.create') }}" class="sidebar-item active flex items-center gap-3 px-4 py-3 rounded-xl text-gray-300 hover:text-white transition-all">
            ...
            <div class="p-8">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-400 mt-1">Fill in the details to create your event</p>
                    </div>
                </div>
                
                <form action="{{ route('organizer.event.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
